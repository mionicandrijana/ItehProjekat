		...
		<div class="5grid-layout">
			<div class="row">
				<div class="9u mobileUI-main-content" id="content">
					<h2>Natália Kelly - Shine (Austria) </h2>
					<br>
					<br>
	       <div class="vendor">
        	<iframe width="560" height="315" src="http://www.youtube.com/embed/8dpcKwdSBhM" frameborder="0" allowfullscreen></iframe>
	      </div>
		   <br>
		  <br>
...
//Operacije nad bazom
                    ...
                    $sql = "INSERT INTO  eurosong.komentari (video,ime, komentar) VALUES ('4','" . $ime . "', '" . $komentar . "')";
                    if (mysql_query($sql)) {
...
//Ako POST parametri nisu prosledeni
	...
	//include 'konekcija.php';
        ...
        $sql= mysql_query( "SELECT ime, komentar FROM komentari WHERE video='4';");
